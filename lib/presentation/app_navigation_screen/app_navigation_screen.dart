...
import 'package:dsplus_finance/presentation/map_location_bottomsheet/map_location_bottomsheet.dart';
...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapLoginPageTabContainer(BuildContext context) {
    NavigatorService.pushNamed(
 ...
 onTapDetailsPage(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapCurrencyExchange(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapATMLocation(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.atmLocationScreen,
    );
  }

  onTapMapLocation(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => MapLocationBottomsheet.builder(context),
