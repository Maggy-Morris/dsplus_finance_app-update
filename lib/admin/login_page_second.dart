    ...
    if (_formkey.currentState!.validate()) {
      try {
        ...
        if (documentSnapshot.exists) {
          ...
          await prefs.setString('userName', documentSnapshot.get('name'));
          await prefs.setString('jobTitle', documentSnapshot.get('jobTitle'));
          await prefs.setString('userImageUrl', documentSnapshot.get('userImageUrl'));
        }
        route();
